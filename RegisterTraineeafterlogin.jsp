...
<div class="topnav">
          ...
          <div class="registerdiv">
                     ...
                     <div class="form">
                           ...
                           <form class="registerform" action="RegisterTraineeafterlogin" method="post">

                               <h2><center><font color=orange>Register Trainee</font></center></h2>
                               ...
                               <table  border='0' width='480px' cellpadding='0' cellspacing='0' align='center'>
                                ...
                                <tr>
                                 ...
                                 <tr>
                                       ...
                                       <tr>
                                               <td align='left'><font color=red>*</font><label>Password:</label></td><td><input id="pass" type="password" name="pass" id="pass" placeholder="PASSWORD"></td>
                                                                     </tr>
                                                              <tr> <td>&nbsp;</td> </tr>
                                 
                                       <tr>
                                               <td align='left'><font color=red>*</font><label>Confirm Password:</label></td><td><input id="cpass" type="password" name="cpass" id="cpass" placeholder="CONFIRM PASSWORD"></td>
                                               </tr>
                                                              <tr> <td>&nbsp;</td> </tr>
